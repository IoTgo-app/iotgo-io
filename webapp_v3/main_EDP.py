...
with cardDeck_placeholder:
    ...
    if st.session_state['sidebar_mode']=="editing_example":
        ...
        # st.session_state['io_index'] == "in2":
            ...
            st.image(baseURL_codeChunks+"code_"+it2en_inout[st.session_state['input2is']]+".png",   width=cardWidth)             if not st.session_state['prevInput2']==st.session_state['input2is']:  
            ...
            st.image(baseURL_codeChunks+"code_"+it2en_inout[st.session_state['output0is']]+".png",   width=cardWidth)             if not st.session_state['prevOutput']==st.session_state['output0is']:
            ...
            st.image(baseURL_codeChunks+"code_"+it2en_inout[st.session_state['output2is']]+".png",   width=cardWidth)             if not st.session_state['prevOutput2']==st.session_state['output2is']:
