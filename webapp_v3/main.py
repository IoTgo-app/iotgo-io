...
jscode=""
if gamelevel==0:
	urlis,jscode=genURL(groupnum,p2ptype,gamelevel,[input_name[0],output_name[0]])
elif gamelevel==1:
	urlis,jscode=genURL(groupnum,p2ptype,gamelevel,[input_name[0],output_name[0]],[input_name[1],output_name[1]])
